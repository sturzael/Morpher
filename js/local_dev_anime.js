...
$('#link2').click(function() {
  ...
  changeback = 'img/pink.jpg';
  setframe = '0 28%, 19% 94%, 87% 100%, 100% 0';
})

$('#link3').click(function() {
  $('#seo').attr('class', 'basic');
  $('body').append("<style>@keyframes web {0% {clip-path:polygon(" + setframe + ");}100%{clip-path:polygon(21% 5%, 18% 72%, 73% 93%, 93% 20%);}</style>");
...
$('#link4').click(function() {
  $('#seo').attr('class', 'basic');
  $('body').append("<style>@keyframes design {0% {clip-path:polygon(" + setframe + ");}100%{clip-path:polygon(23% 24%, 5% 85%, 100% 100%, 80% 0);}</style>");
